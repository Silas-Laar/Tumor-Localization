...
def process_tif_video():
    # --- HARD-CODED PATHS ---
    tif_file_path = r"C:\Semester Project\Experimentation\3 Months\Myoblast__8_MMStack_Pos0-Puit-Haut-Gauche.ome_processed.tiff"
    converted_folder_path = r"C:\Semester Project\Experimentation\3 Months\converted"
    processed_folder_path = r"C:\Semester Project\Experimentation\3 Months\processed"
